#ifndef BK_OTHER_KSORT_H
#define BK_OTHER_KSORT_H
    ...
    void ks_shuffle_##name(size_t n, type_t a[]) {                                                                      \
        ...
        for (i = n; i > 1; --i) {                                                                                       \
            ...
            tmp = a[j]; a[j] = a[i-1]; a[i-1] = tmp;                                                                    \
                                                                                                                        ...
                                                                                                                        \
    /* FIXME: NOT TESTED!!! */                                                                                          \
    void ks_sample_##name(size_t n, size_t r, type_t a[]) {                                                             \
...
// insertion sort is fastest and stable for small arrays of int
...
#define ks_radix_sort(name, beg, end) radix_sort_##name(beg, end)

#endif  //BK_OTHER_KSORT_H
