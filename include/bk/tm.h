...
pub TM_TLID_T tm_union_tlid_for(BK_TM *, btypeid_t *);                  // union tlid (sorted and all unions expanded)
...
// id reservation
pub btypeid_t tm_reserve(BK_TM *, btypeid_t btypeid, btypeid_t spaceid);
