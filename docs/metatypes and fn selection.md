...
signatures lookup is hit count sorted list of signature - could be a hash map in future i.e. probe, if missing then hash and probe
 ...
 the following schema encodes types into a u16 array and can handle up to 128k type space
 ...
 |  PL / HC / A1-TN2   |       A1-TN1        |       PL / SS       |
 | PPPP PHHH HHHH HTTT | 1QTT TTTT TTTT TTTT | PPPP PPPP PPP0 0001 |

 |       PL / HC       |       A1-TN1        |       PL / SS       |
 | PPPP PHHH HHHH H000 | 0QTT TTTT TTTT TTTT | PPPP PPPP PPP0 0000 |


 e.g. 2 arg overloads
 |         MSB         |         ...         |         ...         |         ...         |         LSB         |

 |  PL / HC / A2-TN2   |       A2-TN1        |       A1-TN2        |       A1-TN1        |       PL / SS       |
 | PPPP PHHH HHHH HTTT | 1QTT TTTT TTTT TTTT | 00000 000 0000 0TTT | 1QTT TTTT TTTT TTTT | PPPP PPPP PPP0 0011 |

 |       PL / HC       |       A2-TN1        |       A1-TN2        |       A1-TN1        |       PL / SS       |
 | PPPP PHHH HHHH H000 | 0QTT TTTT TTTT TTTT | 00000 000 0000 0TTT | 1QTT TTTT TTTT TTTT | PPPP PPPP PPP0 0010 |

 |       PL / HC       |       A2-TN2        |       A2-TN1        |       A1-TN1        |       PL / SS       |
 | PPPP PHHH HHHH H000 | 00000 000 0000 0TTT | 1QTT TTTT TTTT TTTT | 0QTT TTTT TTTT TTTT | PPPP PPPP PPP0 0010 |

 |       PL / HC       |                     |       A2-TN1        |       A1-TN1        |       PL / SS       |
 | PPPP PHHH HHHH H000 | 0000 0000 0000 0000 | 0QTT TTTT TTTT TTTT | 0QTT TTTT TTTT TTTT | PPPP PPPP PPP0 0001 |
...
XXXX PPPP PPPP PPPP  PPPP PPPP PPPP XXXX

type prefix is u32 (as u16 is not big enough for the 128k * 2 types)
12 bytes
...
should isPtr etc be encoded in typeId

lower 24 bits -> are RP
isPtr
hasPtr
...
hasPtr - 1 bit
hasT - 1 bit
metatype enum - 4 bits - nominal-1, intersection-2, union-3, tuple-4, struct-5, record-6, seq-7, map-8, fn-9, schema variable-10


typeDesc - 4 bytes
lower 24 bits - RP into the relevant description array
familial - 1 bit
explicit - 1 bit
orthogonal - 1 bit
...
typeList - size prefixed list of typeId
typeListToMap
symList - size prefixed list of symId

intersectDescs - alias of typeLists
unionDescs - alias of typeLists
tupleDescs - alias of typeLists

structDescs - buffer of structDesc
structDesc - nameListRP, typeList

nameLists - buffer of symList


nameRP - u32
slotRP - u16 - handles structs up to 64k in size
...
typeId is u32, index into the summary array,
first N (1024?)are optimised for lookup
typeId to nameRP mapping - array for first N types, hash for all others?
name to typeId mapping - hash
names are immutable - so the strings can be in their own areana
relative pointers for char *name - relocatable

4GB of VM for string interning
